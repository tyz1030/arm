...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.radioDetect = QtGui.QRadioButton(self.centralwidget)
        self.radioDetect.setGeometry(QtCore.QRect(480, 10, 117, 22))
        self.radioDetect.setObjectName(_fromUtf8("radioDetect"))
...
### Gripper2 slider        
        ...
        self.sldrGrip2.setMinimum(-90)
        self.sldrGrip2.setMaximum(120)
...
###  button 3 initial rotation wrist
...
###
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.radioDetect.setText(_translate("MainWindow", "Detect", None))
        ...
        self.G1LableS.setText(_translate("MainWindow", "RotateGpr", None))
        ...
        self.btn_task1.setText(_translate("MainWindow", "Mirror", None))
        self.btn_task2.setText(_translate("MainWindow", "Stack them 3!", None))
        self.btn_task3.setText(_translate("MainWindow", "Line them up", None))
        self.btn_task4.setText(_translate("MainWindow", "Stack them high!", None))
        self.btn_exec_6.setText(_translate("MainWindow", "Pyramid", None))
